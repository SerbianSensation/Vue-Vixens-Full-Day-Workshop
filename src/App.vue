    ...
    <main :class="{ 'orange-green': themeSwitched }">
      <div class="app-container">
        <header class="app-header dark-brown">
          ...
          <v-toolbar>
            <v-toolbar-items>
              ...
              <router-link to="/favorites">
                <!-- add nav link to favorites plus number of favorites !-->
                <!-- v-model will make the badge visible only if favorites is not empty !-->
                <v-badge
          ...
          <v-btn @click="swapTheme()">Switch theme</v-btn>
        </header>
        <!-- add the home and pets pages via the router !-->
